...
//		Proposta entrada = Proposta.builder().nome(null).documento("094.246.920-80").email("teste@teste.com.br")
...
//		Proposta entrada = Proposta.builder().nome("Usuario Teste").documento(null).email("teste@teste.com.br")
//				.endereco("Rua Teste, numero 500").salario(new BigDecimal(1000)).build();
//
//		Optional<Proposta> retorno = obterPropostaSaida();
//
...
//		Proposta entrada = Proposta.builder().nome("Usuario Teste").documento("094.246.920-80").email(null)
//				.endereco("Rua Teste, numero 500").salario(new BigDecimal(1000)).build();
//
//		Optional<Proposta> retorno = obterPropostaSaida();
//		String payload = objectMapper.writeValueAsString(entrada);
